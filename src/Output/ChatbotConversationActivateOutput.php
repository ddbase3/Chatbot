...
final class ChatbotConversationActivateOutput extends AbstractChatbotConversationOutput {

	public static function getName(): string {
		return 'chatbotconversationactivate';
	}

	protected function handle(array $input): array {
		$state = $this->conversationService->activateConversation(
