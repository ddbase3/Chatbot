...
class ChatbotDisplay implements IDisplay, ISchemaProvider {
	...
	protected function getClientConfig(): array {
		...
		return [
			'service' => $this->normalizeTechnicalKey((string) ($config['service'] ?? $defaults['service'])),
	 ...
	 *
	 * The stored service value is a technical service name. The concrete URL is
	 * generated by ILinkTargetService, because the host system owns routing and
	 * link generation.
	 */
	...
	public function getSchema(): array {
		return [
			...
			'properties' => [
				...
				'service' => [
					'type' => 'string',
					'description' => 'Technical chatbot service name',
					'default' => 'chatbotservice'
				],
